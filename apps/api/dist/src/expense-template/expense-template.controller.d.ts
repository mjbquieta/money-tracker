...
export declare class ExpenseTemplateController {
    private readonly expenseTemplateService;
    constructor(expenseTemplateService: ExpenseTemplateService);
    ...
    update(userId: UUID, id: UUID, payload: UpdateExpenseTemplateDto): Promise<{
        category: {
            id: string;
            name: string;
            createdAt: Date;
