...
let TagController = class TagController {
    ...
    tagExpense(userId, expenseId, payload) {
        return this.tagService.tagExpense(userId, expenseId, payload.tagIds);
    }
    getExpenseTags(userId, expenseId) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, tag_dto_1.CreateTagDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, tag_dto_1.UpdateTagDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.Put)('expenses/:expenseId'),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Param)('expenseId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, tag_dto_1.TagExpenseDto]),
    __metadata("design:returntype", void 0)
], TagController.prototype, "tagExpense", null);
__decorate([
    (0, common_1.Get)('expenses/:expenseId'),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Param)('expenseId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], TagController.prototype, "getExpenseTags", null);
exports.TagController = TagController = __decorate([
    (0, swagger_1.ApiTags)('Tags'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('api/v1/tags'),
